...
class OrderPaymentSucceededNotificationTest extends TestCase
{
    public function test_notification_uses_orders_high_priority_queue_for_all_channels(): void
    {
        ...
        $notification = new CustomerOrderPaymentSucceededNotification($order);
    ...
    public function test_notification_array_payload_contains_order_details(): void
    {
        ...
        $this->assertSame('150.00', $payload['grand_total']);
    }
}
