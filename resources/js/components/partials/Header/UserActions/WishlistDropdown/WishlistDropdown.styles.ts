export const styles = {
    ...
    wishlistIconFilled: 'fill-current',
    wishlistBadge:
    ...
    guestText: 'text-sm text-muted-foreground',
    loginLink:
        'px-4 py-2 bg-primary text-primary-foreground rounded-lg font-medium hover:bg-primary/90 transition-colors',
    loadingContainer:
