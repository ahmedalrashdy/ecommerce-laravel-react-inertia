...
use App\Data\Notifications\Returns\ReturnReceivedData;
...
class CustomerReturnReceivedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject("تم استلام المرتجع #{$this->returnOrder->return_number}")
            ->greeting("مرحباً {$notifiable->name}")
            ->line("تم استلام المرتجع رقم {$this->returnOrder->return_number} للطلب رقم {$orderNumber}.")
            ->line('سنبدأ الآن عملية الفحص والإجراءات اللازمة.')
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return (new ReturnReceivedData(
            return_number: $this->returnOrder->return_number,
            order_number: $orderNumber,
            title: 'تم استلام المرتجع',
            message: "تم استلام المرتجع رقم {$this->returnOrder->return_number} للطلب رقم {$orderNumber}.",
